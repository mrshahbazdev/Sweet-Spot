...
new class extends Component {
    ...
    // Subjective Metrics
    public $chemistry_score = 3;
    public $growth_score = 3;
    public $payment_willingness = 3;
    public $repeat_rate = 0;
    ...
    public function create()
    {
        ...
        $this->chemistry_score = 3;
        $this->growth_score = 3;
        $this->payment_willingness = 3;
    ...
    public function edit($id)
    {
        ...
        $this->chemistry_score = $customer->chemistry_score ?? 3;
        $this->growth_score = $customer->growth_score ?? 3;
        $this->payment_willingness = $customer->payment_willingness ?? 3;
        $this->repeat_rate = $customer->repeat_rate ?? 0;
        $this->recommendations = $customer->recommendations ?? 0;
    ...
    public function save()
    {
        ...
        $data = [
            ...
            'payment_willingness' => $this->payment_willingness,
