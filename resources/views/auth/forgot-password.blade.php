...
<head>
    ...
    <title>Sweet Spot | Forgot Password</title>
        ...
        <div
            ...
            <div class="px-8 pt-10 pb-6 text-center">
                <div class="flex items-center justify-center gap-2 text-primary mb-8">
                    ...
                    <h2 class="text-slate-900 dark:text-slate-100 text-2xl font-bold leading-tight tracking-tight">Sweet
                        Spot</h2>
                </div>
            ...
            <div
                ...
                <span class="text-xs text-slate-400 uppercase tracking-widest font-bold">Secure Access</span>
                <span class="material-symbols-outlined text-slate-300 dark:text-slate-600">shield_lock</span>
            </div>
        </div>

        <div class="mt-8 flex gap-6">
            <a href="#" class="text-slate-400 hover:text-primary text-xs font-medium transition-colors">Help Center</a>
            <a href="#" class="text-slate-400 hover:text-primary text-xs font-medium transition-colors">Privacy
                Policy</a>
            <a href="#" class="text-slate-400 hover:text-primary text-xs font-medium transition-colors">Terms of
                Service</a>
        </div>
    </div>
</body>
